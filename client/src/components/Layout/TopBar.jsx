...
export default function TopBar() {
  ...
  return (
    <header className="h-[52px] bg-white border-b border-arkalon-lightgrey flex items-center px-5 gap-4 flex-shrink-0">
      {/* Page title */}
      <h1 className="font-montserrat font-bold text-arkalon-navy text-lg w-36 flex-shrink-0">
